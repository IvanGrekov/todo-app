...
export default function RemoveIcon({ color = COLORS.white }: IBaseIconProps): JSX.Element {
    return (
        <svg fill={color} enableBackground="new 0 0 40 40" viewBox="0 0 40 40" xmlSpace="preserve">
            <g>
